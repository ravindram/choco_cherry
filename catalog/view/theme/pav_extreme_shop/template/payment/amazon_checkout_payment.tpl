...
<div class="main-columns container"><?php echo $content_top; ?>
  ...
  <div class="buttons">
    <div class="pull-left">
      <a href="<?php echo $back; ?>" class="btn btn-default"><?php echo $text_back; ?></a>
    </div>
    <div class="pull-right">
      <input class="btn btn-default" id="continue-button" type="submit" value="<?php echo $text_continue; ?>" />
    </div>
  </div>
