...
<div class="product-block tools" itemtype="http://schema.org/Product" itemscope>	
	<?php if ($product['thumb']) {    ?>
		<div class="image">
			...
			<a href="<?php echo $zimage;?>" class="info-view colorbox product-zoom btn btn-default btn-outline cboxElement" title="<?php echo $product['name']; ?>"><i class="fa fa-search-plus"></i><span><?php echo $olang->get('zoom_product'); ?></span></a>
			<?php } ?>

				<div class="compare btn btn-default btn-outline">			
					<a class=""  onclick="addToCompare('<?php echo $product['product_id']; ?>');" title="<?php echo $button_compare; ?>">
						<span><?php echo $button_compare; ?></span>
					</a>	
				</div>	
				<div class="wishlist btn btn-default btn-outline">
	...
	<div class="product-meta">		  
		...
		<div class="right">		
			<div class="action">				
				...
				<?php } ?>				
				<div class="quickview btn btn-default btn-outline">
