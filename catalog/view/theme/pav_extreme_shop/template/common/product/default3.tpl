...
<div class="product-block text-center product-v2 item-default" itemtype="http://schema.org/Product" itemscope> 
  ...
  <div class="block-img text-center">
    ...
    <?php if( !isset($listingConfig['catalog_mode']) || !$listingConfig['catalog_mode'] ) { ?>
      <div class="cart">            
        <button data-loading-text="Loading..." class="btn btn-sm btn-outline-inverse border-1 radius-left-5x" type="button" onclick="cart.addcart('<?php echo $product['product_id']; ?>');">
    ...
    <div class="wishlist">
        <button class="btn btn-sm btn-outline-inverse border-1" type="button" onclick="wishlist.addwishlist('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i><span class=""><?php echo $objlang->get('button_wishlist'); ?></span></button> 
      </div>      
