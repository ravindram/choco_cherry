         ...
         <div class="action">
             <div class="quick-view">
                 ...
                 <?php if ( isset($quickview) && $quickview ) { ?>
                     <a data-toggle="tooltip" data-placement="top" title="<?php echo $objlang->get('quick_view'); ?>" class="pav-colorbox btn btn-default btn-inverse" href="<?php echo $this->url->link("themecontrol/product",'product_id='.$product['product_id'] );?>">
                        <i class="fa fa-eye"></i>
