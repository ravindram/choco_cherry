<div class="product-filter space-20 space-padding-10 white clearfix">
  <div class="display">
  ...
  <div class="filter-right">
    <div class="product-compare pull-right"><a href="<?php echo $compare; ?>" class="btn btn-sm btn-success " id="compare-total"><?php echo $text_compare; ?></a></div>
